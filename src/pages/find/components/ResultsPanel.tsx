    ...
    <Switch>
      ...
      <Case condition={loading}>
        <div aria-busy="true" aria-live="polite">
          <span className="sr-only">{t(lang.value, "find.searching")}</span>
      ...
      <Case condition={results.length > 0}>
        ...
        >
          <span className="font-mono uppercase tracking-label text-micro text-fg-4">
            {t(lang.value, "find.colName")}
          </span>
          <span className="font-mono uppercase tracking-label text-micro text-fg-4">
            {t(lang.value, "find.colSource")}
          </span>
          <span className="font-mono uppercase tracking-label text-micro text-fg-4 text-right">
            {t(lang.value, "find.colInstalls")}
          </span>
          <span className="font-mono uppercase tracking-label text-micro text-fg-4 text-right">
            {t(lang.value, "find.colActions")}
          </span>
        </motion.div>
        <motion.div
          key={listKey}
